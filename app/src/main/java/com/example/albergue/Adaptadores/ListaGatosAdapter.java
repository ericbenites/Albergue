...
public class ListaGatosAdapter extends RecyclerView.Adapter<ListaGatosAdapter.ViewHolder> {

    private List<MascotasRegistro> listaGatos;
    private Context context;

    public ListaGatosAdapter(List<MascotasRegistro> listaGatos, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final MascotasRegistro mascotasRegistro = listaGatos.get(position);
        StorageReference storageReference = FirebaseStorage.getInstance()
                .getReference().child("Gatos").child(mascotasRegistro.getIdRescatado() + ".jpg");
